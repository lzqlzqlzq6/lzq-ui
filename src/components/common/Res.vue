<template>
  ...
  >
    ...
    <el-form-item>
      <el-col :span="6"
        ><el-button type="primary" @click="res('ruleForm')"
          >登录</el-button
        ></el-col
      >
      <el-col :span="12"
...
export default {
  ...
  data() {
    ...
    var validatePassChecck = (rule, value, callback) => {
        if (value === '') {
    ...
    return {
      ...
      rules: {
        ...
        passCheck: [{ validator: validatePassChecck, trigger: "blur" }],
  ...
  methods: {
    ...
    res(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$emit('resDialogVisible',false);
        } else {
